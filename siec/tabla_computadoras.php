...
function getData() {
    ...
    formaData.append('columns', 'oficial,departamento,puesto,usuario,rpe,nombre_equipo,activo_fijo,inventario,numero_de_serie,marca,modelo,procesador,velocidad,so,ip,vlan,mac_wifi,mac_ethernet,memoria,disco_duro,dominio,d_activo,antivirus,escritorio_remoto,estado,observaciones'); // Columnas visibles
    formaData.append('id', 'id_computadora'); // Clave primaria (no visible)
