...
if(isset($_GET['borrar'])){
  ...
  $datosborrar = $datos->borrar($conecta,'vlan',$where);
}
?>
<!doctype html>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-group me-2">
          ...
          <button type="button" class="btn btn-sm btn-outline-secondary"><a href="nuevo_vlan.php">Agregar</a></button>
            <!--    
...
function getData() {
    ...
    let editFile = "nuevo_vlan.php"; // Cambia según el archivo
    let deleteFile = "tabla_vlan.php"; // Cambia según el archivo
    let formaData = new FormData();
    formaData.append('table', 'vlan'); // Tabla dinámica
    formaData.append('columns', 'numero,gateway'); // Columnas dinámicas
    formaData.append('id', 'no_vlan'); // Clave primaria
