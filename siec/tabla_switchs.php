...
function getData() {
    ...
    let editFile = "nuevo_switch.php"; // Cambia según el archivo
    let deleteFile = "tabla_switchs.php"; // Cambia según el archivo
    let formaData = new FormData();
    formaData.append('table', 'switches'); // Tabla dinámica
    formaData.append('columns', 'id_switch,siitic,Columna1,ip,mask,gw,marca,hostaname,pid,serial,ubicacion,descripcion,firmware'); // Columnas dinámicas
