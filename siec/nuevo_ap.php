...
if(isset($_GET['editar'])){
  ...
  $datoseditar = $datos->leer($conecta,'aps',$where);
}
...
switch($_POST['accion']){
  case 'insertar':
          ...
          $usuario->insertar_datos($conecta,'aps',$datos);
          $_SESSION['mensaje'] = "Los datos se registraron con éxito.";
          header("Location: nuevo_ap.php");
          die();
      break;
    case  'edicion':
        $where = "`id_ap` = $registro";
        $usuario = new ControlFormulario('');
        $usuario->actualizar($conecta,'aps',$datos,$where);
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          ...
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2"><?php if(isset($_GET['editar'])){ 
                        echo 'Edicion del registro de Access Point';
                      }else{
                        echo 'Registro de Nuevo Access Point';
                      } ?>
                      </h1>
            <!--
                ...
                <div class="col-md-4">
                      ...
                      <option value=""></option>
                        ...
                        if(isset($datoseditar[0]['ubicacion'])){ 
                          echo '<option value="' . $datoseditar[0]['ubicacion'] . '">' . $datoseditar[0]['cve_depto']['departamento'] . '</option>';
                        } 
                  ...
                  <div class="row g-3">
                    ...
                    <div class="col-sm-4">
                      <label for="serial" class="form-label">Numero de serie</label>
                      <input type="text" class="form-control" id="serial" name="serial" placeholder="" <?php if(isset($datoseditar[0]['serial'])){ 
                        echo 'value="' . $datoseditar[0]['serial'] . '"';
                      } 
                        ?>
                         >
                      <div class="invalid-feedback">
                    ...
                    <div class="col-sm-4">
                      ...
                      <input type="text" class="form-control" id="channel" name="channel" placeholder="" <?php if(isset($datoseditar[0]['channel'])){ 
                        echo 'value="' . $datoseditar[0]['channel'] . '"';
                      }
                        ?>>
                      <div class="invalid-feedback">
                      dato invalido
                    ...
                    <div class="col-sm-4">
                      <label for="mask" class="form-label">Mascara de subred</label>
                      <input type="text" class="form-control" id="mask" name="mask" placeholder="" <?php if(isset($datoseditar[0]['mask'])){ 
                        echo 'value="' . $datoseditar[0]['mask'] . '"';
                      } 
                        ?> maxlength="16">
                      <div class="invalid-feedback">
                      dato invalido
                    ...
                    <div class="col-sm-4">
                      ...
                      <input type="text" class="form-control" id="gw" name="gw" placeholder="" <?php if(isset($datoseditar[0]['gw'])){ 
                        echo 'value="' . $datoseditar[0]['gw'] . '"';
                      } 
                        ?> maxlength="16">
                      <div class="invalid-feedback">
                      dato invalido
                    ...
                    <div class="col-sm-3">
                      ...
                      <input type="text" class="form-control" id="firmware" name="firmware" placeholder="" <?php if(isset($datoseditar[0]['firmware'])){ 
                        echo 'value="' . $datoseditar[0]['firmware'] . '"';
                      } 
                        ?>>
                      <div class="invalid-feedback">
                      dato invalido
                    ...
                    <div class="col-sm-4">
                      ...
                      <input type="text" class="form-control" id="sec" name="sec" placeholder="" <?php if(isset($datoseditar[0]['sec'])){ 
                        echo 'value="' . $datoseditar[0]['sec'] . '"';
                      }
                        ?>>
                      <div class="invalid-feedback">
                      dato invalido
                    ...
                    <div class="col-sm-4">
                      <label for="newpass" class="form-label">Newpass</label>
                      <input type="text" class="form-control" id="newpass" name="newpass" placeholder="" <?php if(isset($datoseditar[0]['newpass'])){ 
                        echo 'value="' . $datoseditar[0]['newpass'] . '"';
                      }
                        ?>>
                      <div class="invalid-feedback">
                      dato invalido
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="descripcion" class="form-control letra" rows="3"><?php if(isset($datoseditar[0]['descripcion'])){ 
                        echo $datoseditar[0]['descripcion'];
                      } 
                        ?></textarea>
                    </div>
