...
if(isset($_GET['editar'])){
  ...
  $where = "`no_vlan` = $registro";
  $datos = new ControlFormulario('');
  $datoseditar = $datos->leer($conecta,'vlan',$where);
}
...
switch($_POST['accion']){
  case 'insertar':
          ...
          $usuario->insertar_datos($conecta,'vlan',$datos);
          $_SESSION['mensaje'] = "Los datos se registraron con éxito.";
          header("Location: nuevo_vlan.php");
          die();
      break;
    case  'edicion':
        $where = "`no_vlan` = $registro";
        $usuario = new ControlFormulario('');
        $usuario->actualizar($conecta,'vlan',$datos,$where);
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          ...
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2"><?php if(isset($_GET['editar'])){ 
                        echo 'Edicion del registro de Vlan';
                      }else{
                        echo 'Registro de Nueva Vlan';
                      } ?>
                      </h1>
            <!--
                ...
                <form action="" method="post">
                  ...
                  <div class="row g-3">
                    <div class="col-sm-2">
                      ...
                      <input type="text" class="form-control" id="marca" name="numero" placeholder="" <?php if(isset($datoseditar[0]['numero'])){ 
                        echo 'value="' . $datoseditar[0]['numero'] . '"';
                      } 
                        ?>
                        >
                    ...
                    <div class="col-sm-3">
                      <label for="modelo" class="form-label">Puerta de salida(gateway)</label>
                      <input type="text" class="form-control" id="modelo" name="gateway" placeholder="" <?php if(isset($datoseditar[0]['gateway'])){ 
                        echo 'value="' . $datoseditar[0]['gateway'] . '"';
                      } 
                        ?>>
                      <div class="invalid-feedback">
                      dato invalido
