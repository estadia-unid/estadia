...
if(isset($_GET['borrar'])){
  ...
  $datosborrar = $datos->borrar($conecta,'categorias',$where);
}
?>
<!doctype html>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-group me-2">
          ...
          <button type="button" class="btn btn-sm btn-outline-secondary"><a href="nuevo_categoria.php">Agregar</a></button>
            <!--    
...
function getData() {
    ...
    let editFile = "nuevo_categoria.php"; // Cambia según el archivo
    let deleteFile = "tabla_categorias.php"; // Cambia según el archivo
    let formaData = new FormData();
    formaData.append('table', 'categorias'); // Tabla dinámica
    formaData.append('columns', 'id_categoria,cve_categoria,categoria'); // Columnas dinámicas
    formaData.append('id', 'id_categoria'); // Clave primaria
