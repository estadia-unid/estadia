...
if(isset($_GET['editar'])){
  ...
  $datoseditar = $datos->leer($conecta,'categorias',$where);
}
...
switch($_POST['accion']){
  case 'insertar':
          ...
          $usuario->insertar_datos($conecta,'categorias',$datos);
          $_SESSION['mensaje'] = "Los datos se registraron con éxito.";
          header("Location: nuevo_categoria.php");
          die();
      break;
    case  'edicion':
        $where = "`id_categoria` = $registro";
        $usuario = new ControlFormulario('');
        $usuario->actualizar($conecta,'categorias',$datos,$where);
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          ...
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2"><?php if(isset($_GET['editar'])){ 
                        echo 'Edicion del registro de Categorias';
                      }else{
                        echo 'Registro de Nueva Categorias';
                      } ?>
                      </h1>
            <!--
          ...
          <div class="container" >
              <div class="col-md-auto col-lg-auto">
                ...
                <form action="" method="post">
                  ...
                  <div class="row g-3">
                    <div class="col-sm-2">
                      <label for="marca" class="form-label">CVE De Categoria</label>
                      <input type="text" class="form-control" id="marca" name="cve_categoria" placeholder="" <?php if(isset($datoseditar[0]['cve_categoria'])){ 
                        echo 'value="' . $datoseditar[0]['cve_categoria'] . '"';
                      } 
                        ?>
                        >
                    ...
                    <div class="col-sm-3">
                      ...
                      <input type="text" class="form-control" id="modelo" name="categoria" placeholder="" <?php if(isset($datoseditar[0]['categoria'])){ 
                        echo 'value="' . $datoseditar[0]['categoria'] . '"';
                      } 
                        ?>>
                      <div class="invalid-feedback">
                      dato invalido
