...
if(isset($_GET['borrar'])){
  ...
  $datosborrar = $datos->borrar($conecta,'usuarios',$where);
}
?>
<!doctype html>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-group me-2">
          ...
          <button type="button" class="btn btn-sm btn-outline-secondary"><a href="nuevo_usuario.php">Agregar</a></button>
            <!--    
    ...
    <div class="col">
        <table class="table table-bordered table-striped table-hover">
            <thead>
                ...
                <th class="sort asc">Fecha de creacion</th>
                <th></th>
            </thead>
...
function getData() {
    ...
    let editFile = "nuevo_usuario.php"; // Cambia según el archivo
    let deleteFile = "tabla_usuarios.php"; // Cambia según el archivo
    let formaData = new FormData();
    formaData.append('table', 'usuarios'); // Tabla dinámica
    formaData.append('columns', 'id,rpe,fecha_creacion'); // Columnas dinámicas
    formaData.append('id', 'id'); // Clave primaria
