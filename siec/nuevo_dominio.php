...
if(isset($_GET['editar'])){
  ...
  $where = "`id_dominio` = $registro";
  $datos = new ControlFormulario('');
  $datoseditar = $datos->leer($conecta,'dominios',$where);
}
...
switch($_POST['accion']){
  case 'insertar':
          ...
          $usuario->insertar_datos($conecta,'dominios',$datos);
          $_SESSION['mensaje'] = "Los datos se registraron con éxito.";
          header("Location: nuevo_dominio.php");
          die();
      break;
    case  'edicion':
        $where = "`id_dominio` = $registro";
        $usuario = new ControlFormulario('');
        $usuario->actualizar($conecta,'dominios',$datos,$where);
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          ...
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2"><?php if(isset($_GET['editar'])){ 
                        echo 'Edicion del registro de Dominio';
                      }else{
                        echo 'Registro de Nuevo Dominio';
                      } ?>
                      </h1>
            <!--
          ...
          <div class="container" >
              <div class="col-md-auto col-lg-auto">
                ...
                <form action="" method="post">
                  ...
                  <div class="row g-3">
                    <div class="col-sm-2">
                      <label for="marca" class="form-label">Numero de Vlan</label>
                      <input disabled type="text" class="form-control" id="marca" placeholder="" <?php if(isset($datoseditar[0]['id_dominio'])){ 
                        echo 'value="' . $datoseditar[0]['id_dominio'] . '"';
                      } 
                        ?>
                        >
                    ...
                    <div class="col-sm-3">
                      <label for="modelo" class="form-label">dominio</label>
                      <input type="text" class="form-control" id="modelo" name="dominio" placeholder="" <?php if(isset($datoseditar[0]['dominio'])){ 
                        echo 'value="' . $datoseditar[0]['dominio'] . '"';
                      } 
                        ?>>
                      <div class="invalid-feedback">
                      dato invalido
