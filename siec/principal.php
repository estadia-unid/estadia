...
<header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
  ...
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">  <img width="30" height="30" class="rounded float-start" src="imagen_usuario.php"><?php echo "Hola". $_SESSION['rpe']; ?></a>
