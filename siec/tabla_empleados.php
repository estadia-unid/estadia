    ...
    <div class="col">
        <table class="table table-bordered table-striped table-hover">
            <thead>
                ...
                <th class="sort asc">Numero de Plaza</th>
                <th class="sort asc">Categoria</th>
                <th class="sort asc">Fecha de Nacimiento</th>
                <th class="sort asc">Edad</th>
                <th class="sort asc">Fecha de Antiguedad</th>
                <th class="sort asc">Fecha de Jubilacion</th>
                <th class="sort asc">Entidad Federativa</th>
                <th class="sort asc">Rama</th>
                <th class="sort asc">Tipo de Contrato</th>
                <th class="sort asc">Estado Civil</th>
                <th class="sort asc">Correo</th>
                <th class="sort asc">Curp</th>
                <th class="sort asc">Alta Permanente</th>
