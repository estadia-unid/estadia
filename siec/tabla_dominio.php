...
if(isset($_GET['borrar'])){
  ...
  $datosborrar = $datos->borrar($conecta,'dominios',$where);
}
?>
<!doctype html>
  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Dominios</h1>
        <div class="btn-toolbar mb-2 mb-md-0">

        <div class="btn-group me-2">
            
          <button type="button" class="btn btn-sm btn-outline-secondary"><a href="nuevo_dominio.php">Agregar</a></button>
            <!--    
...
function getData() {
    ...
    let editFile = "nuevo_dominio.php"; // Cambia según el archivo
    let deleteFile = "tabla_dominio.php"; // Cambia según el archivo
    let formaData = new FormData();
    formaData.append('table', 'dominios'); // Tabla dinámica
    formaData.append('columns', 'id_dominio,dominio'); // Columnas dinámicas
    formaData.append('id', 'id_dominio'); // Clave primaria
