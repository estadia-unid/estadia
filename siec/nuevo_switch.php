...
if(isset($_GET['editar'])){
  ...
  $datoseditar = $datos->leer($conecta,'switches',$where);
}
...
switch($_POST['accion']){
  case 'insertar':
          ...
          $usuario->insertar_datos($conecta,'switches',$datos);
          $_SESSION['mensaje'] = "Los datos se registraron con éxito.";
          header("Location: nuevo_switch.php");
          die();
      break;
    case  'edicion':
        $where = "`id_switch` = $registro";
        $usuario = new ControlFormulario('');
        $usuario->actualizar($conecta,'switches',$datos,$where);
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          ...
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2"><?php if(isset($_GET['editar'])){ 
                        echo 'Edicion del registro de Switch';
                      }else{
                        echo 'Registro de Nuevo Switch';
                      } ?>
                      </h1>
            <!--
