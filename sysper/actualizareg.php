...
if (isset($_POST['guardar'])) {
    ...
    $user = mysqli_real_escape_string($conecta, $_POST['user']);
    $cibermedio = mysqli_real_escape_string($conecta, $_POST['cibermedio']);
    $gpo_edit = mysqli_real_escape_string($conecta, $_POST['gpo_edit']);
    $url = mysqli_real_escape_string($conecta, $_POST['url']);
    $pais = mysqli_real_escape_string($conecta, $_POST['pais']);
    $idioma = mysqli_real_escape_string($conecta, $_POST['idioma']);
    $categoria = mysqli_real_escape_string($conecta, $_POST['categoria']);

    $sql_query = "UPDATE cibermedios SET fecha='$fecha', hora='$hora', user='$user', cibermedio='$cibermedio', gpo_edit='$gpo_edit', url='$url', pais='$pais', idioma='$idioma', categorizacion='$categoria' WHERE id='$id'";
    
    if (mysqli_query($conecta, $sql_query)){
        $msg = "Sus datos fueron actualizados exitosamente";
    } else {
        $msg2 = "Error no se actualizaron los datos: " . mysqli_error($conecta);
    }
}
?>
<!DOCTYPE html>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown active">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="actualizareg.php" class="dropdown-item active">Actualizar</a>
                        </div>
                    </div>
                    <a href="buscar_id.php" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Busqueda</a>
                    <a href="#" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Tablas</a>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row vh-40 bg-secondary rounded align-items-center justify-content-center mx-2">
                    <div class="col-12">
                        ...
                        <form class="row g-3 bg-light-gray p-4" action="actualizareg.php" method="POST" autocomplete="off">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="cibermedio" name="cibermedio" value="<?php echo $cibermedio?>">
                            </div>
                            <div class="col-md-4">
                                <label for="gpo_edit" class="form-label">Precio</label>
                                <input type="text" class="form-control" id="gpo_edit" name="gpo_edit" value="<?php echo $gpo_edit?>">
                            </div>
                            <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="categoria" name="categoria" value="<?php echo $categorizacion?>" >
                </div>
                            <div class="col-12">
                                <button type="submit" class="btn btn-primary" name="guardar">Guardar edicion</button>
                            </div>
                        </form>
                    </div>
                </div>
