...
$query = "SELECT rpe, nombre, a_paterno, a_materno, categ FROM empleados WHERE rpe LIKE '%$searchTerm%' LIMIT 10";
...
while ($row = $resultado->fetch_assoc()) {
    ...
    $empleados[] = array(
        ...
        "text" => $row['categ'] . ' - ' . $nombre_completo . ' - ' . $row['rpe'] // Mostrar RPE y nombre completo
    );
}
